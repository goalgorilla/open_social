...
class BookAddBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  protected function blockAccess(AccountInterface $account) {
    ...
    assert($route_user instanceof UserInterface, "The user parameter should be automatically upcast by Drupal, check the route configuration.");
    if ($account->id() == $route_user->id() && $account->hasPermission("create book content")) {
