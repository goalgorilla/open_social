...
class PostViewBuilder extends EntityViewBuilder {
   ...
   * {@inheritdoc}
   */
  public static function createInstance(ContainerInterface $container, EntityTypeInterface $entity_type): EntityViewBuilder|PostViewBuilder|\Drupal\Core\Entity\EntityHandlerInterface|static {
    return new static(
      $entity_type,
