...
class FollowTaxonomyActivityContext extends ActivityContextBase {
   ...
   * {@inheritdoc}
   */
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition): FollowTaxonomyActivityContext|ActivityContextBase|\Drupal\Core\Plugin\ContainerFactoryPluginInterface|static {
    return new static(
      $configuration,
      $plugin_id,
      $plugin_definition,
