...
class SocialUserPasswordForm extends UserPasswordForm {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $admin_link = ($site_mail && $show_mail) ? Link::fromTextAndUrl($this->t('site administrator'), Url::fromUri('mailto:' . $site_mail))->toString() : $this->t('site administrator');
    $this->messenger()->addStatus($this->t('Due to privacy concerns, the identity of registered email addresses will not be disclosed. Therefore, a password reset link has been sent to you only if you have entered a valid email address or username.
