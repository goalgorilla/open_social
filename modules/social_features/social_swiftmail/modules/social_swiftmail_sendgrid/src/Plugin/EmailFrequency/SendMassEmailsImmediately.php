...
namespace Drupal\social_swiftmail_sendgrid\Plugin\EmailFrequency;
...
use Drupal\activity_send_email\Plugin\EmailFrequency\Immediately;

/**
 * Sends emails to users Immediately using Sendgrids substitution tokens.
 */
class SendMassEmailsImmediately extends Immediately {
