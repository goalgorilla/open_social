...
class SocialGroupAddForm extends FormBase {
  ...
  public function getGroupTypeElement() {
    ...
    foreach ($group_types as $group_type) {
      $group_types_options[$group_type->id()] = $this->t('@label', ['@label' => $group_type->label()]);
      $group_types_descriptions[$group_type->id()] = ['#description' => $this->t('@desc', ['@desc' => $group_type->getDescription()])];
    }
