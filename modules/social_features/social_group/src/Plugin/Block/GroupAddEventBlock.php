 ...
 * )
 */
class GroupAddEventBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  public function build() {
    ...
    if (is_object($group)) {
      ...
      $build['content'] = Link::fromTextAndUrl($this->t('Create Event'), $url)->toRenderable();
