 ...
 * @ingroup social_group_api
 */
function hook_social_group_flexible_group_group_visibility_description_alter($key, &$description) {
  switch ($key) {
    case 'custom_role_1':
 ...
 * @ingroup social_group_api
 */
function hook_social_group_flexible_group_allowed_join_method_description_alter($key, &$description) {
  switch ($key) {
