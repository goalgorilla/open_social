            ...
            'display_options' => [
              ...
              'fields' => [
                ...
                'nothing' => [
                  ...
                  'alter' => [
                    'alter_text' => TRUE,
                    'text' => '<a href="/group/{{ gid }}/content/{{ id }}/approve-membership?destination=/group/{{ gid }}/membership-requests">Approve membership</a>',
                    'make_link' => FALSE,
                ...
                'nothing_1' => [
                  ...
                  'alter' => [
                    'alter_text' => TRUE,
                    'text' => '<a href="/group/{{ gid }}/content/{{ id }}/reject-membership?destination=/group/{{ gid }}/membership-requests">Reject Membership</a>',
                    'make_link' => FALSE,
              ...
              'footer' => [
                'area' => [
                  ...
                  'tokenize' => TRUE,
                  'content' => [
                    'value' => '<a href="/group/{{ gid }}">Back to group</a>',
                    'format' => 'basic_html',
                  ],
                  'plugin_id' => 'text',
                ],
