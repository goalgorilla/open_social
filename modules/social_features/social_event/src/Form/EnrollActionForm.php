...
class EnrollActionForm extends FormBase implements ContainerInjectionInterface {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    if ($node->field_enroll_method->value === EventEnrollmentInterface::ENROLL_METHOD_REQUEST && !$isNodeOwner) {
    ...
    if (!$current_user->isAnonymous()) {
      ...
      if ($enrollment = array_pop($enrollments)) {
        ...
        elseif ($node->field_enroll_method->value && $node->field_enroll_method->value === EventEnrollmentInterface::ENROLL_METHOD_REQUEST && !$isNodeOwner) {
          $enroll_request_status = $enrollment->field_request_or_invite_status->value;
          $event_request_ajax = TRUE;
          if ($enroll_request_status === EventEnrollmentInterface::REQUEST_PENDING) {
      ...
      if (!$isNodeOwner && (empty($enrollment) && $node->field_enroll_method->value && $node->field_enroll_method->value === EventEnrollmentInterface::ENROLL_METHOD_REQUEST)
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    if ($current_user->isAnonymous()) {
      ...
      if ($node->get('field_enroll_method')->value === EventEnrollmentInterface::ENROLL_METHOD_REQUEST) {
