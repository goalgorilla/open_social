...
namespace Drupal\social_content_export\Plugin\Action;
 ...
 *
 * @Action(
 *   id = "social_content_export_user_action",
 *   label = @Translation("Export the selected content(s) to CSV"),
 *   type = "node",
 *   confirm_form_route_name = "social_content_export.export_content_confirm"
 * )
 */
