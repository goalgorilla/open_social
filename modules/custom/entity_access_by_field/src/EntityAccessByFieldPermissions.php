...
class EntityAccessByFieldPermissions implements ContainerInjectionInterface {
   ...
   */
  public function getRealmForFieldValue(string $op, string $entity_type, string $bundle_id, string $field_name, string $field_value): string {
    return $op . '_' . $entity_type . '_' . $bundle_id . '_' . $field_name . '_' . $field_value;
  }
   ...
   *
   * @return array
   *   Returns all the fields with the entity type entity_access_field.
   */
  public function getEntityAccessFields(string $entity, mixed $bundle): array {
    $fields = [];
    $field_definitions = $this->entityFieldManager->getFieldDefinitions($entity, (string) $bundle->id());
