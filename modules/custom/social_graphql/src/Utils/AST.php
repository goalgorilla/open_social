...
namespace Drupal\social_graphql\Utils;
 ...
 *
 * @internal
 * This class is forward ported from webonyx/graphql-php:15 and will be removed
 * without backwards compatibility once the library version is updated.
 */
class AST
{
  /**
