 ...
 */
$config['search_api.server.social_solr']['backend_config']['connector_config']['index_timeout'] = '100';
$config['search_api.server.social_solr']['backend_config']['connector_config']['timeout'] = '100';
$config['search_api.server.social_solr']['backend_config']['connector_config']['optimize_timeout'] = '100';
$config['search_api.server.social_solr']['backend_config']['connector_config']['finalize_timeout'] = '100';
