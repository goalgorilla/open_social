...
Feature: Create Follow Content
  ...
  Scenario: Successfully create follow content
    ...
    Then I click "Follow content"
    And I wait for AJAX to finish
    When I am on "/following"
    Then "Behat Post" should precede "Behat Event" for the query "#social-follow-content-table .name"
    And "Behat Event" should precede "Behat Topic" for the query "#social-follow-content-table .name"
    When I click "Title"
    Then I should be on "/following?type=All&order=title&sort=asc"
    And "Behat Event" should precede "Behat Post" for the query "#social-follow-content-table .name"
    And "Behat Post" should precede "Behat Topic" for the query "#social-follow-content-table .name"
    When I click "Title"
    Then I should be on "/following?type=All&order=title&sort=desc"
    And "Behat Topic" should precede "Behat Post" for the query "#social-follow-content-table .name"
    And "Behat Post" should precede "Behat Event" for the query "#social-follow-content-table .name"
    When I click "Reset"
    Then I should be on "/following"
    And "Behat Post" should precede "Behat Event" for the query "#social-follow-content-table .name"
    And "Behat Event" should precede "Behat Topic" for the query "#social-follow-content-table .name"
