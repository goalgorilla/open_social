...
Feature: Event bulk actions
  ...
  Scenario: Send bulk emails to enrollees by event author
    ...
    And I fill in input ".form-type-select" with "event_attendee_1@example.com" and select "event_attendee_1@example.com"
    And I press "Save"
    And I should see "Add enrollees"
    And I click the xth "1" element with the css ".btn.dropdown-toggle"
    And I should see "Add directly"
    And I click "Add directly"
    And I should see "Find people by name or email address"
    And I fill in input ".form-type-select" with "event_attendee_2@example.com" and select "event_attendee_2@example.com"
    And I press "Save"
    And I should see "Add enrollees"
    And I click the xth "1" element with the css ".btn.dropdown-toggle"
    And I should see "Add directly"
    And I click "Add directly"
    And I should see "Find people by name or email address"
    And I fill in input ".form-type-select" with "event_attendee_3@example.com" and select "event_attendee_3@example.com"
    And I press "Save"
