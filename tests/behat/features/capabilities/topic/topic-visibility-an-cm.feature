...
Feature: Validate access and visibility of topics for Anonymous user and content manager
  ...
  #Add a user to the group
	...
	#And I make a screenshot with the name "all-topics via AN2"
	...
	Then I should not see "This is a community topic in group"
    	And I should see "Access denied"
	...
	#And I make a screenshot with the name "all-topics via CM" 
