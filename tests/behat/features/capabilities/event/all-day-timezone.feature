...
Feature: All day event for different timezones
  ...
  Scenario: Successfully create an all day event in GMT - 8
    ...
    And I set the configuration item "system.date" with key "date_default_timezone" to "America/Los_Angeles"
    ...
    And I should see "This is a timezone test for all day events has been created."
    ...
    And I press "Save"
    And I should see "Event This is a test event - edit has been updated"
    And I should see "1 Jan '25"
  ...
  Scenario: Successfully create an all day event with two event days in GMT - 8
    ...
    And I am viewing the event "Test for all day events"
    And I should see "1 January 2035 - 2 January 2035"

    # Check all events
    And I am on "community-events"
    And I should see "Test for all day events"
