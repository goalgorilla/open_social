 ...
 * @phpstan-type ListItemNodeArray array{
 *   type: 'list-item',
 *   version: int,
 *   children?: list<NodeArray>
 * }&NodeArray
 */
final class ListItemNode implements NodeInterface {

  /**
   * The node type.
   */
  private const TYPE = 'list-item';
  ...
  /**
   * Creates a ListItemNode from an array.
   *
   ...
   * {@inheritdoc}
   *
   * @phpstan-return ListItemNodeArray
   */
  public function toArray(): array {
    ...
    /** @phpstan-var ListItemNodeArray $result */
