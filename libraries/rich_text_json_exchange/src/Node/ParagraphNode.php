 ...
 * @phpstan-type ParagraphNodeArray array{
 *   type: 'paragraph',
 *   version: int,
 *   children?: list<NodeArray>,
 * }&NodeArray
 */
final class ParagraphNode implements NodeInterface {
  ...
  /**
   * Creates a ParagraphNode from an array.
   *
    ...
    if ($hasChildrenKey && is_array($data['children'])) {
      foreach ($data['children'] as $childData) {
        if (is_array($childData)) {
          /** @phpstan-var NodeArray $childData */
   ...
   * {@inheritdoc}
   *
   * @phpstan-return ParagraphNodeArray
   */
  public function toArray(): array {
    ...
    /** @phpstan-var ParagraphNodeArray $result */
