!function (o, v) {
  Drupal.behaviors.navbarSecondaryScrollable = {
    attach: function (c) {
      var i = c.classList && c.classList.contains("navbar-scrollable") && !c.parentElement.classList.contains("groups-secondary-nav") ? [c] : c.querySelectorAll(".navbar-scrollable:not(.groups-secondary-nav *)");
