    ...
    attach: function (context, settings) {
      ...
      $(once('navbarCollapseMainNav', '#main-navigation', context)).each(function () {
        ...
        $mainNavigation.on('show.bs.collapse', function () {
          $bodyEl.addClass('open-navbar-menu').removeClass('navbar-menu-closing navbar-menu-opening');
        ...
        $mainNavigation.on('hide.bs.collapse', function () {
          ...
          $bodyEl.addClass('navbar-menu-closing').removeClass('navbar-menu-opening');
        });
