...
(function ($, Drupal) {
  ...
  $.extend(Drupal.theme, /** @lends Drupal.theme */{
    ...
    dropbuttonToggle: function (options) {
      return '<li class="dropbutton-toggle"><button type="button" class="btn btn-default"><span class="dropbutton-arrow"><span class="visually-hidden">' + options.title + '</span></span></button></li>';
    }
  });
