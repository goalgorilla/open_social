# Social Orange
Social Orange is made to provide as a demo as well as a default style for Open
Social. This is a sub theme of socialbase.

Social Orange uses Gulp.js as a task runner, so that it can do many tasks
automatically:
...
'socialorange' are renamed to guarantee a proper working theme. Social Orange itself
...
libraries with the socialorange variant. This means there is a relation between
